...
import DetailForgotPassword from "./src/pages/ForgotPassword/DetailForgotPassword";
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        />
        <Stack.Screen
          name={NAVIGATOR_SCREEN.DETAIL_FORGOT_PASSWORD}
          component={DetailForgotPassword}
          options={{ headerShown: false }}
        />
      </Stack.Navigator>
    </NavigationContainer>
